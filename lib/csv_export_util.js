...
var exportCSV = function exportCSV(dataString, keys, filename, separator, noAutoBOM, excludeCSVHeader) {
  return dataString.then((data)=>{
    const = toString(data, keys, separator, excludeCSVHeader);
